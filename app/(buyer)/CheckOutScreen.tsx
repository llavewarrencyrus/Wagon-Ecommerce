  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        Alert.alert('Order Placed! 🎉', 'Your order has been placed successfully. You can track it in your Account orders.', [
          {
            text: 'View Orders',
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {selectedAddress ? (
            <View style={styles.addressBody}>
              <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 4 }}>
                ...
                {selectedAddress.prefer && <View style={styles.defaultBadge}><Text style={styles.defaultBadgeText}>Default</Text></View>}
              </View>
            ...
            <TouchableOpacity style={styles.addAddressPrompt} onPress={() => router.push('/AddEditAddress')}>
        ...
        <View style={styles.sectionCard}>
          ...
          {selectedPurchase.map((item, index) => {
            ...
            return (
              <View key={item.cart_id || index} style={[styles.itemRow, index > 0 && styles.itemBorderTop]}>
                <Image source={{ uri: imageUri }} style={styles.itemThumbnail} />
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.paymentOptions}>
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <FontAwesome5 name="money-bill-wave" size={18} color={paymentMethod === 'cod' ? Colors.primary : '#666'} />
            ...
            >
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <MaterialCommunityIcons name="cellphone-check" size={20} color={paymentMethod === 'gcash' ? Colors.primary : '#666'} />
                <View style={{ marginLeft: 12 }}>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>
              {shippingFee === 0 ? <Text style={{ color: '#2e7d32', fontWeight: 'bold' }}>FREE</Text> : `₱${shippingFee.toFixed(2)}`}
            </Text>
          </View>
