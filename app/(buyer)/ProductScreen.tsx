    ...
    useEffect(() => {
        ...
        const listener = scrollY.addListener(({ value }) => {
            ...
            navigation.setOptions({
                headerTitle: () => (
                    <Animated.View style={{ display: backgroundColor, width: width * 0.65, opacity: searchOpacity }}>
                        <DummySearchBar />
                    </Animated.View>
                ),
                headerBackground: () => (
            ...
            {product && product.product_image ? (
                <>
                                ...
                                <View style={styles.ratingOverviewRow}>
                                    ...
                                    <View style={styles.progressBarsCol}>
                                        {[
                                            ...
                                            <View key={bar.star} style={styles.progressBarRow}>
                                    ...
                                    {[
                                        {
                                            ...
                                            comment: 'The heavyweight fabric quality is exceptional. Boxy oversized drape sits perfectly and holds up great after multiple washes. Fast shipping too!',
                                        },
                                        {
                                            name: 'Maria S.',
                                            date: 'Aug 28, 2024',
                                            variant: 'Vintage Bone • Medium (M)',
                                            comment: 'Exceeded all my expectations! Texture is super premium and the color is gorgeous. 100% recommended!',
                                        },
                                    ].map((rev, idx) => (
                                        <View key={idx} style={[styles.reviewItemCard, idx > 0 && styles.reviewItemBorder]}>
                                            <View style={styles.reviewerHeader}>
                                                ...
                                                <StarRatingDisplay rating={5} starSize={12} color={Colors.star} starStyle={{ width: 0, height: '100%' }} />
                                            </View>
                    ...
                    <View style={styles.bottomBarContainer}>
                        ...
                        {/* 2. Cart Shortcut Button with Badge */}
                        <TouchableOpacity
                            style={styles.iconActionBtn}
