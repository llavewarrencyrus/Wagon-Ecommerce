...
import { Modal, View, Text, TouchableOpacity, TouchableWithoutFeedback, StyleSheet, Image, Dimensions, Alert, ActivityIndicator } from 'react-native';
                    ...
                    >
                        ...
                        <View style={{ width: '100%' }}>
                                    ...
                                    <View style={styles.quantityStepperWrap}>
                                        ...
                                        <View style={styles.stepperContainer}>
                                            ...
                                            <Text style={styles.stepperValueText}>
                                                {selectVariant ? (cartStock > 0 ? quantity : 0) : 1}
                                            </Text>
                                            <TouchableOpacity
                            ...
                            <View style={styles.optionSection}>
                                ...
                                />
                                {selectedDimensions && (
                                    <Text style={styles.dimensionsText}>Dimensions: {selectedDimensions}</Text>
                                )}
                            </View>
